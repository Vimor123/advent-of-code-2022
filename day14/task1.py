    ...
    for i in range(len(path) - 1):
        ...
        if currPosition[0] == nextPosition[0]:
            ...
            for j in range(fromCoord, toCoord + 1):
                cave[j][currPosition[0] - minX] = "#"

        elif currPosition[1] == nextPosition[1]:
            toCoord = max(currPosition[0], nextPosition[0]) - minX
            fromCoord = min(currPosition[0], nextPosition[0]) - minX
